![esteira de dados](img/esteira.gif)
...
monitoramento de drift por período. Começou como POC em Streamlit e hoje roda
como módulo da plataforma interna.
...
source, licença MIT, para agentes de IA e servidores MCP: orquestração, prompt
engineering, graph engineering e auto-aprendizado. O que eu faço no trabalho fica em repositório
